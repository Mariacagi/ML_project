...
lista_recorrer_Genre.sort()

lista_recorrer_Platform = ['Wii',
 'NES',
 'GB',
 'DS',
 'X360',
...
lista_recorrer_Platform.sort()

lista_recorrer_Publisher =  ['Nintendo',
...
for i in lista_recorrer_Publisher:
    i = str(i).replace(' ','_')
    k.append(i)

lista_recorrer_Publisher = k

lista_recorrer_Publisher.sort()